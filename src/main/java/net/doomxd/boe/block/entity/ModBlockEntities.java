...
import net.doomxd.boe.block.entity.custom.ElseworldBlockEntity;
...
public class ModBlockEntities {
     public static final BlockEntityType<ElseworldBlockEntity> ELSEWORLD_BLOCK_ENTITY_BLOCK_ENTITY_TYPE =
             Registry.register(BuiltInRegistries.BLOCK_ENTITY_TYPE,
                     Identifier.fromNamespaceAndPath(BeyondOnesEyes.MOD_ID,
                             "elseworld_be"), FabricBlockEntityTypeBuilder
                             .create(ElseworldBlockEntity::new, ModBlocks.ELSEWHERE_BLOCK).build());
